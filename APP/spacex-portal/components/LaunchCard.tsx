...
export default function LaunchCard({ launch }: LaunchCardProps) {
  ...
  return (
    <div className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10 hover:border-white/20 transition-all hover:shadow-xl hover:shadow-blue-500/10 group">
      ...
      <div className="space-y-2 mb-4">
        <p className="text-gray-300 text-sm">
          <span className="font-medium text-gray-400">Rocket:</span> {launch.rocket.rocket_name}
        </p>
        <p className="text-gray-300 text-sm">
          <span className="font-medium text-gray-400">Launch Site:</span> {launch.launch_site?.site_name_long || 'Unknown'}
        </p>
        <p className="text-gray-300 text-sm">
